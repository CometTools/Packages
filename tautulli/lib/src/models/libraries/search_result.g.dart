...
TautulliSearchResult _$TautulliSearchResultFromJson(Map<String, dynamic> json) {
  return TautulliSearchResult(
    ...
    minYear: TautulliUtilities.ensureIntegerFromJson(json['min_year']),
    maxYear: TautulliUtilities.ensureIntegerFromJson(json['max_year']),
    ...
    mediaInfo:
        TautulliSearchResult._mediaInfoFromJson(json['media_info'] as List),
  );
}

Map<String, dynamic> _$TautulliSearchResultToJson(
        TautulliSearchResult instance) =>
    <String, dynamic>{
      'media_type': TautulliUtilities.mediaTypeToJson(instance.mediaType),
      'sub_media_type':
          TautulliUtilities.mediaTypeToJson(instance.subMediaType),
      ...
      'live': instance.live,
      'media_info': TautulliSearchResult._mediaInfoToJson(instance.mediaInfo),
    };
