...
class TautulliSearchResult {
    ...
    @JsonKey(name: 'sub_media_type', toJson: TautulliUtilities.mediaTypeToJson, fromJson: TautulliUtilities.mediaTypeFromJson)
    ...
    @JsonKey(name: 'media_info', toJson: _mediaInfoToJson, fromJson: _mediaInfoFromJson)
    ...
    factory TautulliSearchResult.fromJson(Map<String, dynamic> json) => _$TautulliSearchResultFromJson(json);
    /// Serialize a [TautulliSearchResult] object to a JSON map.
    Map<String, dynamic> toJson() => _$TautulliSearchResultToJson(this);

    static List<TautulliMediaInfo> _mediaInfoFromJson(List<dynamic> mediaInfo) => mediaInfo.map((info) => TautulliMediaInfo.fromJson((info as Map<String, dynamic>))).toList();
    static List<Map<String, dynamic>> _mediaInfoToJson(List<TautulliMediaInfo> mediaInfo) => mediaInfo.map((info) => info.toJson()).toList();
}
