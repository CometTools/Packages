...
class TautulliSyncedItem {
    ...
    @JsonKey(name: 'device_name', fromJson: TautulliUtilities.ensureStringFromJson)
    ...
    @JsonKey(name: 'metadata_type', fromJson: TautulliUtilities.ensureStringFromJson)
    ...
    /// The amount of items.
    @JsonKey(name: 'item_count', fromJson: TautulliUtilities.ensureIntegerFromJson)
    final int itemCount;

    /// The amount of completed items.
    @JsonKey(name: 'item_complete_count', fromJson: TautulliUtilities.ensureIntegerFromJson)
    final int itemCompleteCount;

    /// The amount of downloaded items.
    @JsonKey(name: 'item_downloaded_count', fromJson: TautulliUtilities.ensureIntegerFromJson)
    final int itemDownloadedCount;

    /// The percentage completed of downloaded items.
    @JsonKey(name: 'item_downloaded_percent_complete', fromJson: TautulliUtilities.ensureIntegerFromJson)
    ...
    @JsonKey(name: 'photo_quality', fromJson: TautulliUtilities.ensureIntegerFromJson)
    final int photoQuality;

    /// The synced video quality.
    @JsonKey(name: 'video_quality', fromJson: TautulliUtilities.ensureIntegerFromJson)
