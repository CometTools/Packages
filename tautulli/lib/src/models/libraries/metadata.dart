...
class TautulliMetadata {
    ...
    /// Deserialize a JSON map to a [TautulliMetadata] object.
    factory TautulliMetadata.fromJson(Map<String, dynamic> json) => _$TautulliMetadataFromJson(json);
    /// Serialize a [TautulliMetadata] object to a JSON map.
