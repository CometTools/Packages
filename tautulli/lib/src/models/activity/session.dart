...
class TautulliSession {
    ...
    @JsonKey(name: 'session_key', fromJson: TautulliUtilities.ensureIntegerFromJson)
    final int sessionKey;

    /// _Unknown_: Somehow related to the progress percentage.
    @JsonKey(name: 'view_offset', fromJson: TautulliUtilities.ensureIntegerFromJson)
    final int viewOffset;

    /// How much of the content has been played.
    @JsonKey(name: 'progress_percent', fromJson: TautulliUtilities.ensureIntegerFromJson)
    final int progressPercent;

    /// Quality profile of the stream.
    @JsonKey(name: 'quality_profile', fromJson: TautulliUtilities.ensureStringFromJson)
    final String qualityProfile;

    /// Quality of the synced version of the content.
    @JsonKey(name: 'synced_version_profile', fromJson: TautulliUtilities.ensureStringFromJson)
    final String syncedVersionProfile;

    /// Quality of the optimized version of the content.
    @JsonKey(name: 'optimized_version_profile', fromJson: TautulliUtilities.ensureStringFromJson)
    ...
    @JsonKey(name: 'channel_stream', fromJson: TautulliUtilities.ensureIntegerFromJson)
    ...
    @JsonKey(name: 'grandparent_title', fromJson: TautulliUtilities.ensureStringFromJson)
    final String grandparentTitle;

    /// The original title of the content.
    @JsonKey(name: 'original_title', fromJson: TautulliUtilities.ensureStringFromJson)
    ...
    @JsonKey(name: 'rating_image', fromJson: TautulliUtilities.ensureStringFromJson)
    final String ratingImage;

    /// The audience rating of the content.
    @JsonKey(name: 'audience_rating', fromJson: TautulliUtilities.ensureDoubleFromJson)
    final double audienceRating;

    /// Link to an image for the audience rating.
    @JsonKey(name: 'audience_rating_image', fromJson: TautulliUtilities.ensureStringFromJson)
    final String audienceRatingImage;

    /// The user rating of the content.
    @JsonKey(name: 'user_rating', fromJson: TautulliUtilities.ensureDoubleFromJson)
    final double userRating;

    /// Duration of the content.
    @JsonKey(name: 'duration', fromJson: TautulliUtilities.millisecondsDurationFromJson)
    ...
    @JsonKey(name: 'parent_thumb', fromJson: TautulliUtilities.ensureStringFromJson)
    final String parentThumb;

    /// Thumbnail path for the content's grandparent.
    @JsonKey(name: 'grandparent_thumb', fromJson: TautulliUtilities.ensureStringFromJson)
    ...
    @JsonKey(name: 'last_viewed_at', fromJson: TautulliUtilities.millisecondsDateTimeFromJson)
    ...
    @JsonKey(name: 'parent_guid', fromJson: TautulliUtilities.ensureStringFromJson)
    final String parentGuid;

    /// The globally unique identifier for the content's grandparent.
    @JsonKey(name: 'grandparent_guid', fromJson: TautulliUtilities.ensureStringFromJson)
    final String grandparentGuid;

    /// List of director's names who directed the content.
    @JsonKey(name: 'directors', fromJson: TautulliUtilities.ensureStringListFromJson)
    final List<String> directors;

    /// List of writer's names who wrote the content.
    @JsonKey(name: 'writers', fromJson: TautulliUtilities.ensureStringListFromJson)
    ...
    @JsonKey(name: 'children_count', fromJson: TautulliUtilities.ensureIntegerFromJson)
    ...
    @JsonKey(name: 'video_codec_level', fromJson: TautulliUtilities.ensureStringFromJson)
    final String videoCodecLevel;

    /// Bitrate of the video stream.
    @JsonKey(name: 'video_bitrate', fromJson: TautulliUtilities.ensureIntegerFromJson)
    ...
    @JsonKey(name: 'video_chroma_subsampling', fromJson: TautulliUtilities.ensureStringFromJson)
    final String videoChromaSubsampling;

    /// Color primaries of the video stream.
    @JsonKey(name: 'video_color_primaries', fromJson: TautulliUtilities.ensureStringFromJson)
    final String videoColorPrimaries;

    /// Color range of the video stream.
    @JsonKey(name: 'video_color_range', fromJson: TautulliUtilities.ensureStringFromJson)
    final String videoColorRange;

    /// Color space of the video stream.
    @JsonKey(name: 'video_color_space', fromJson: TautulliUtilities.ensureStringFromJson)
    final String videoColorSpace;

    /// Color TRC of the video stream.
    @JsonKey(name: 'video_color_trc', fromJson: TautulliUtilities.ensureStringFromJson)
    final String videoColorTRC;

    /// Frame rate of the video stream.
    @JsonKey(name: 'video_frame_rate', fromJson: TautulliUtilities.ensureDoubleFromJson)
    final double videoFrameRate;

    /// Reference frames in the video stream.
    @JsonKey(name: 'video_ref_frames', fromJson: TautulliUtilities.ensureIntegerFromJson)
    ...
    @JsonKey(name: 'video_width', fromJson: TautulliUtilities.ensureIntegerFromJson)
    final int videoWidth;

    /// Language of the video stream.
    @JsonKey(name: 'video_language', fromJson: TautulliUtilities.ensureStringFromJson)
    final String videoLanguage;

    /// Language code of the video stream.
    @JsonKey(name: 'video_language_code', fromJson: TautulliUtilities.ensureStringFromJson)
    final String videoLanguageCode;

    /// Scan type of the video stream.
    @JsonKey(name: 'video_scan_type', fromJson: TautulliUtilities.ensureStringFromJson)
    final String videoScanType;

    /// Dynamic range of the video stream.
    @JsonKey(name: 'video_dynamic_range', fromJson: TautulliUtilities.ensureStringFromJson)
    ...
    @JsonKey(name: 'is_home_user', fromJson: TautulliUtilities.ensureBooleanFromJson)
    final bool isHomeUser;

    /// Is the user allowed to sync content?
    @JsonKey(name: 'is_allow_sync', fromJson: TautulliUtilities.ensureBooleanFromJson)
    final bool isAllowSync;

    /// Is the user restricted?
    @JsonKey(name: 'is_restricted', fromJson: TautulliUtilities.ensureBooleanFromJson)
    ...
    /// Is the user deleted?
    @JsonKey(name: 'deleted_user', fromJson: TautulliUtilities.ensureBooleanFromJson)
    final bool deletedUser;

    /// Does the user have guest access to Tautulli?
    @JsonKey(name: 'allow_guest', fromJson: TautulliUtilities.ensureBooleanFromJson)
    final bool allowGuest;

    /// List of libraries that are shared with this user.
    @JsonKey(name: 'shared_libraries', fromJson: TautulliUtilities.ensureIntegerListFromJson)
    ...
    @JsonKey(name: 'ip_address_public', fromJson: TautulliUtilities.ensureStringFromJson)
    ...
    @JsonKey(name: 'platform_name', fromJson: TautulliUtilities.ensureStringFromJson)
    final String platformName;

    /// Version of the streaming device.
    @JsonKey(name: 'platform_version', fromJson: TautulliUtilities.ensureStringFromJson)
    ...
    @JsonKey(name: 'product_version', fromJson: TautulliUtilities.ensureStringFromJson)
    ...
    @JsonKey(name: 'state', toJson: TautulliUtilities.sessionStateToJson, fromJson: TautulliUtilities.sessionStateFromJson)
    ...
    @JsonKey(name: 'location', toJson: TautulliUtilities.sessionLocationToJson, fromJson: TautulliUtilities.sessionLocationFromJson)
    final TautulliSessionLocation location;

    /// Transcoder key/identifier for the session.
    @JsonKey(name: 'transcode_key', fromJson: TautulliUtilities.ensureStringFromJson)
    final String transcodeKey;

    /// Is the transcoder throttled?
    @JsonKey(name: 'transcode_throttled', fromJson: TautulliUtilities.ensureBooleanFromJson)
    final bool transcodeThrottled;

    /// Progress of the transcoder for the session.
    @JsonKey(name: 'transcode_progress', fromJson: TautulliUtilities.ensureIntegerFromJson)
    final int transcodeProgress;

    /// Transcoder speed for the session.
    @JsonKey(name: 'transcode_speed', fromJson: TautulliUtilities.ensureDoubleFromJson)
    final double transcodeSpeed;

    /// Number of audio channels in the transcode stream.
    @JsonKey(name: 'transcode_audio_channels', fromJson: TautulliUtilities.ensureIntegerFromJson)
    final int transcodeAudioChannels;

    /// Audio codec of the transcode stream.
    @JsonKey(name: 'transcode_audio_codec', fromJson: TautulliUtilities.ensureStringFromJson)
    final String transcodeAudioCodec;

    /// Video codec of the transcode stream.
    @JsonKey(name: 'transcode_video_codec', fromJson: TautulliUtilities.ensureStringFromJson)
    final String transcodeVideoCodec;

    /// Height in pixels of the video in the transcode stream.
    @JsonKey(name: 'transcode_height', fromJson: TautulliUtilities.ensureIntegerFromJson)
    final int transcodeHeight;

    /// Width in pixels of the video in the transcode stream.
    @JsonKey(name: 'transcode_width', fromJson: TautulliUtilities.ensureIntegerFromJson)
    final int transcodeWidth;

    /// Container used for the transcode stream.
    @JsonKey(name: 'transcode_container', fromJson: TautulliUtilities.ensureStringFromJson)
    final String transcodeContainer;

    /// Protocol used to transmit the transcode stream.
    @JsonKey(name: 'transcode_protocol', fromJson: TautulliUtilities.ensureStringFromJson)
    final String transcodeProtocol;

    /// Did the transcoder request hardware acceleration?
    @JsonKey(name: 'transcode_hw_requested', fromJson: TautulliUtilities.ensureBooleanFromJson)
    final bool transcodeHardwareRequested;

    /// Hardware decode of the transcode stream.
    @JsonKey(name: 'transcode_hw_decode', fromJson: TautulliUtilities.ensureStringFromJson)
    final String transcodeHardwareDecode;

    /// Hardware decode title of the transcode stream.
    @JsonKey(name: 'transcode_hw_decode_title', fromJson: TautulliUtilities.ensureStringFromJson)
    final String transcodeHardwareDecodeTitle;

    /// Hardware encode of the transcode stream.
    @JsonKey(name: 'transcode_hw_encode', fromJson: TautulliUtilities.ensureStringFromJson)
    final String transcodeHardwarEencode;

    /// Hardware encode title of the transcode stream.
    @JsonKey(name: 'transcode_hw_encode_title', fromJson: TautulliUtilities.ensureStringFromJson)
    ...
    @JsonKey(name: 'audio_decision', toJson: TautulliUtilities.transcodeDecisionToJson, fromJson: TautulliUtilities.transcodeDecisionFromJson)
    final TautulliTranscodeDecision audioDecision;

    /// What decision was made on how to handle the video stream.
    @JsonKey(name: 'video_decision', toJson: TautulliUtilities.transcodeDecisionToJson, fromJson: TautulliUtilities.transcodeDecisionFromJson)
    final TautulliTranscodeDecision videoDecision;

    /// What decision was made on how to handle the subtitle stream.
    @JsonKey(name: 'subtitle_decision', toJson: TautulliUtilities.transcodeDecisionToJson, fromJson: TautulliUtilities.transcodeDecisionFromJson)
    ...
    @JsonKey(name: 'transcode_hw_decoding', fromJson: TautulliUtilities.ensureBooleanFromJson)
    final bool transcodeHardwareDecoding;

    /// Is the transcoder using hardware acceleration for encoding?
    @JsonKey(name: 'transcode_hw_encoding', fromJson: TautulliUtilities.ensureBooleanFromJson)
    final bool transcodeHardwareEncoding;

    /// Container used for the final stream.
    @JsonKey(name: 'stream_container', fromJson: TautulliUtilities.ensureStringFromJson)
    final String streamContainer;

    /// Bitrate of the final stream.
    @JsonKey(name: 'stream_bitrate', fromJson: TautulliUtilities.ensureIntegerFromJson)
    final int streamBitrate;

    /// Aspect ratio of the final video stream.
    @JsonKey(name: 'stream_aspect_ratio', fromJson: TautulliUtilities.ensureDoubleFromJson)
    final double streamAspectRatio;

    /// Codec of the final audio stream.
    @JsonKey(name: 'stream_audio_codec', fromJson: TautulliUtilities.ensureStringFromJson)
    final String streamAudioCodec;

    /// Number of channels in the final audio stream.
    @JsonKey(name: 'stream_audio_channels', fromJson: TautulliUtilities.ensureIntegerFromJson)
    final int streamAudioChannels;

    /// The layout of the channels in the final audio stream.
    @JsonKey(name: 'stream_audio_channel_layout', fromJson: TautulliUtilities.ensureStringFromJson)
    ...
    @JsonKey(name: 'stream_video_codec', fromJson: TautulliUtilities.ensureStringFromJson)
    final String streamVideoCodec;

    /// Resolution of the final video stream.
    @JsonKey(name: 'stream_video_resolution', fromJson: TautulliUtilities.ensureStringFromJson)
    final String streamVideoResolution;

    /// Framerate of the final video stream.
    @JsonKey(name: 'stream_video_framerate', fromJson: TautulliUtilities.ensureStringFromJson)
    ...
    @JsonKey(name: 'stream_duration', fromJson: TautulliUtilities.millisecondsDurationFromJson)
    final Duration streamDuration;

    /// What decision was made on how to handle the final container of the stream.
    @JsonKey(name: 'stream_container_decision', toJson: TautulliUtilities.transcodeDecisionToJson, fromJson: TautulliUtilities.transcodeDecisionFromJson)
    final TautulliTranscodeDecision streamContainerDecision;

    /// Optimized version title.
    @JsonKey(name: 'optimized_version_title', fromJson: TautulliUtilities.ensureStringFromJson)
    final String optimizedVersionTitle;

    /// Is the stream a synced version of the content?
    @JsonKey(name: 'synced_version', fromJson: TautulliUtilities.ensureBooleanFromJson)
    ...
    @JsonKey(name: 'stream_video_full_resolution', fromJson: TautulliUtilities.ensureStringFromJson)
    final String streamVideoFullResolution;

    /// Dynamic range of the final video stream.
    @JsonKey(name: 'stream_video_dynamic_range', fromJson: TautulliUtilities.ensureStringFromJson)
    final String streamVideoDynamicRange;

    /// Codec level of the final video stream.
    @JsonKey(name: 'stream_video_codec_level', fromJson: TautulliUtilities.ensureStringFromJson)
    final String streamVideoCodecLevel;

    /// Bitrate of the final video stream.
    @JsonKey(name: 'stream_video_bitrate', fromJson: TautulliUtilities.ensureIntegerFromJson)
    final int streamVideoBitrate;

    /// Bit depth of the final video stream.
    @JsonKey(name: 'stream_video_bit_depth', fromJson: TautulliUtilities.ensureIntegerFromJson)
    final int streamVideoBitDepth;

    /// Chroma subsampling of the final video stream.
    @JsonKey(name: 'stream_video_chroma_subsampling', fromJson: TautulliUtilities.ensureStringFromJson)
    final String streamVideoChromaSubsampling;

    /// Color primaries of the final video stream.
    @JsonKey(name: 'stream_video_color_primaries', fromJson: TautulliUtilities.ensureStringFromJson)
    final String streamVideoColorPrimaries;

    /// Color range of the final video stream.
    @JsonKey(name: 'stream_video_color_range', fromJson: TautulliUtilities.ensureStringFromJson)
    final String streamVideoColorRange;

    /// Color space of the final video stream.
    @JsonKey(name: 'stream_video_color_space', fromJson: TautulliUtilities.ensureStringFromJson)
    final String streamVideoColorSpace;

    /// Color TRC of the final video stream.
    @JsonKey(name: 'stream_video_color_trc', fromJson: TautulliUtilities.ensureStringFromJson)
    final String streamVideoColorTRC;

    /// Reference frames in the final video stream.
    @JsonKey(name: 'stream_video_ref_frames', fromJson: TautulliUtilities.ensureIntegerFromJson)
    final int streamVideoRefFrames;

    /// Language of the final video stream.
    @JsonKey(name: 'stream_video_language', fromJson: TautulliUtilities.ensureStringFromJson)
    final String streamVideoLanguage;

    /// Language code of the final video stream.
    @JsonKey(name: 'stream_video_language_code', fromJson: TautulliUtilities.ensureStringFromJson)
    final String streamVideoLanguageCode;

    /// Scan type of the final video stream.
    @JsonKey(name: 'stream_video_scan_type', fromJson: TautulliUtilities.ensureStringFromJson)
    final String streamVideoScanType;

    /// What decision was made on how to handle the final video stream.
    @JsonKey(name: 'stream_video_decision', toJson: TautulliUtilities.transcodeDecisionToJson, fromJson: TautulliUtilities.transcodeDecisionFromJson)
    final TautulliTranscodeDecision streamVideoDecision;

    /// Bitrate of the final audio stream.
    @JsonKey(name: 'stream_audio_bitrate', fromJson: TautulliUtilities.ensureIntegerFromJson)
    final int streamAudioBitrate;

    /// Bitrate mode of the final audio stream.
    @JsonKey(name: 'stream_audio_bitrate_mode', fromJson: TautulliUtilities.ensureStringFromJson)
    final String streamAudioBitrateMode;

    /// Sample rate of the final audio stream.
    @JsonKey(name: 'stream_audio_sample_rate', fromJson: TautulliUtilities.ensureIntegerFromJson)
    final int streamAudioSampleRate;

    /// Language of the final audio stream.
    @JsonKey(name: 'stream_audio_language', fromJson: TautulliUtilities.ensureStringFromJson)
    final String streamAudioLanguage;

    /// Language code of the final audio stream.
    @JsonKey(name: 'stream_audio_language_code', fromJson: TautulliUtilities.ensureStringFromJson)
    final String streamAudioLanguageCode;

    /// What decision was made on how to handle the final video stream.
    @JsonKey(name: 'stream_audio_decision', toJson: TautulliUtilities.transcodeDecisionToJson, fromJson: TautulliUtilities.transcodeDecisionFromJson)
    final TautulliTranscodeDecision streamAudioDecision;

    /// Codec of the final subtitle stream.
    @JsonKey(name: 'stream_subtitle_codec', fromJson: TautulliUtilities.ensureStringFromJson)
    final String streamSubtitleCodec;

    /// Container of the final subtitle stream.
    @JsonKey(name: 'stream_subtitle_container', fromJson: TautulliUtilities.ensureStringFromJson)
    final String streamSubtitleContainer;

    /// Format of the final subtitle stream.
    @JsonKey(name: 'stream_subtitle_format', fromJson: TautulliUtilities.ensureStringFromJson)
    final String streamSubtitleFormat;

    /// Is the final subtitle stream forced?
    @JsonKey(name: 'stream_subtitle_forced', fromJson: TautulliUtilities.ensureBooleanFromJson)
    final bool streamSubtitleForced;

    /// Location of the final subtitle stream.
    @JsonKey(name: 'stream_subtitle_location', fromJson: TautulliUtilities.ensureStringFromJson)
    final String streamSubtitleLocation;

    /// Language of the final subtitle stream.
    @JsonKey(name: 'stream_subtitle_language', fromJson: TautulliUtilities.ensureStringFromJson)
    final String streamSubtitleLanguage;

    /// Language code of the final subtitle stream.
    @JsonKey(name: 'stream_subtitle_language_code', fromJson: TautulliUtilities.ensureStringFromJson)
    final String streamSubtitleLanguageCode;

    /// Is the final subtitle stream transient?
    @JsonKey(name: 'stream_subtitle_transient', fromJson: TautulliUtilities.ensureBooleanFromJson)
    final bool streamSubtitleTransient;

    /// What decision was made on how to handle the final subtitle stream.
    @JsonKey(name: 'stream_subtitle_decision', toJson: TautulliUtilities.transcodeDecisionToJson, fromJson: TautulliUtilities.transcodeDecisionFromJson)
