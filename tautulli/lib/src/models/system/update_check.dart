...
class TautulliUpdateCheck {
    ...
    @JsonKey(name: 'current_release', fromJson: TautulliUtilities.ensureStringFromJson)
    final String currentRelease;

    /// The latest release available.
    @JsonKey(name: 'latest_release', fromJson: TautulliUtilities.ensureStringFromJson)
    final String latestRelease;

    /// The current installed version.
    @JsonKey(name: 'current_version', fromJson: TautulliUtilities.ensureStringFromJson)
    final String currentVersion;

    /// The latest version available.
    @JsonKey(name: 'latest_version', fromJson: TautulliUtilities.ensureStringFromJson)
    final String latestVersion;

    /// (git track only) How many commits the current version is behind the latest.
    @JsonKey(name: 'commits_behind', fromJson: TautulliUtilities.ensureIntegerFromJson)
    final int commitsBehind;

    /// (git track only) URL to compare changes between versions.
    @JsonKey(name: 'compare_url', fromJson: TautulliUtilities.ensureStringFromJson)
    final String compareUrl;

    /// URL for the latest release.
    @JsonKey(name: 'release_url', fromJson: TautulliUtilities.ensureStringFromJson)
    final String releaseUrl;

    /// The type of installation (git, docker, etc.)
    @JsonKey(name: 'install_type', fromJson: TautulliUtilities.ensureStringFromJson)
    ...
    factory TautulliUpdateCheck.fromJson(Map<String, dynamic> json) => _$TautulliUpdateCheckFromJson(json);
