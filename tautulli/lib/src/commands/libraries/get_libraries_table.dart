...
Future<TautulliLibrariesTable> _commandGetLibrariesTable(Dio client, {
    ...
    Response response = await client.get('/',
        queryParameters: {
            ...
            if(orderColumn != null && orderColumn != TautulliLibrariesOrderColumn.NULL) 'order_column': orderColumn.value,
    ...
    switch(response.data['response']['result']) {
        case 'success': return TautulliLibrariesTable.fromJson(response.data['response']['data']);
        case 'error':
