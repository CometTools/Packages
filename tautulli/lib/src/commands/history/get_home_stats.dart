...
Future<List<TautulliHomeStats>> _commandGetHomeStats(Dio client, {
    bool grouping,
    int timeRange,
    ...
    switch((response.data['response']['result'] as String)) {
        case 'success': return (response.data['response']['data'] as List).map((stats) => TautulliHomeStats.fromJson(stats)).toList();
        case 'error':
