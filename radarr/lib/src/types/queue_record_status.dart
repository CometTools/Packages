...
extension RadarrQueueRecordStatusExtension on RadarrQueueRecordStatus {
    RadarrQueueRecordStatus? from(String? key) {
        switch(key) {
            case 'completed': return RadarrQueueRecordStatus.COMPLETED;
            case 'delay': return RadarrQueueRecordStatus.DELAY;
            case 'DownloadClientUnavailable': return RadarrQueueRecordStatus.DOWNLOAD_CLIENT_UNAVAILABLE;
            case 'downloading': return RadarrQueueRecordStatus.DOWNLOADING;
            case 'failed': return RadarrQueueRecordStatus.FAILED;
            case 'paused': return RadarrQueueRecordStatus.PAUSED;
            case 'queued': return RadarrQueueRecordStatus.QUEUED;
            case 'warning': return RadarrQueueRecordStatus.WARNING;
        }
        return null;
    }
