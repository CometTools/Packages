...
extension RadarrEventTypeExtension on RadarrEventType {
    ...
    RadarrEventType from(String type) {
        switch(type) {
            ...
            case 'downloadFolderImported': return RadarrEventType.DOWNLOAD_FOLDER_IMPORTED;
            case 'downloadIgnored': return RadarrEventType.DOWNLOAD_IGNORED;
            case 'movieFileDeleted': return RadarrEventType.MOVIE_FILE_DELETED;
    ...
    String get value {
        switch(this) {
            ...
            case RadarrEventType.DOWNLOAD_FOLDER_IMPORTED: return 'downloadFolderImported';
            case RadarrEventType.DOWNLOAD_IGNORED: return 'downloadIgnored';
            case RadarrEventType.MOVIE_FILE_DELETED: return 'movieFileDeleted';
