...
Future<TautulliHistory> _commandGetHistory(Dio client, {
    ...
    Response response = await client.get('/',
        queryParameters: {
            'cmd': 'get_history',
            if(grouping != null) 'grouping': TautulliUtilities.booleanToInteger(grouping),
            ...
            if(mediaType != null && mediaType != TautulliMediaType.NULL) 'media_type': mediaType.value,
            if(transcodeDecision != null && transcodeDecision != TautulliTranscodeDecision.NULL) 'transcode_decision': mediaType.value,
            if(guid != null) 'guid': guid,
            if(orderColumn != null && orderColumn != TautulliHistoryOrderColumn.NULL) 'order_column': orderColumn.value,
            if(orderDirection != null && orderDirection != TautulliOrderDirection.NULL) 'order_direction': orderDirection.value,
