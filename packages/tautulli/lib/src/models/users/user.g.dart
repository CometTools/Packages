...
TautulliUser _$TautulliUserFromJson(Map<String, dynamic> json) {
  return TautulliUser(
    ...
    doNotify: TautulliUser._stringToBooleanChecked(json['do_notify'] as String),
    keepHistory:
        TautulliUser._stringToBooleanChecked(json['keep_history'] as String),
    allowGuest:
        TautulliUser._stringToBooleanChecked(json['allow_guest'] as String),
...
Map<String, dynamic> _$TautulliUserToJson(TautulliUser instance) =>
    <String, dynamic>{
      ...
      'do_notify': TautulliUser._booleanToStringChecked(instance.doNotify),
      'keep_history':
          TautulliUser._booleanToStringChecked(instance.keepHistory),
      'allow_guest': TautulliUser._booleanToStringChecked(instance.allowGuest),
